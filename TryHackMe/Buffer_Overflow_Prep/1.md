...
It still shows 4 possible, with the first in the array usually corrupting the second, so I remove 2e and a0 from my python script, and from mona's array.bin file.
